...
npx create-fluent-prototype my-prototype
...
- **🎨 50+ Fluent UI Components** - Production-ready React components
- **🔄 Multi-page Routing** - Built-in React Router integration
- **💾 Session Management** - Persist prototype data across pages
